...
export default function AcceptInvitePage() {
  ...
  useEffect(() => {
    const fetchInvite = async () => {
      ...
      // Use the secure RPC function - returns an array
  ...
  // Use the secure RPC to accept invite
  const acceptInviteSecure = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Te has unido a ${result?.workshop_name || 'el taller'}`,
      });
      ...
      if (isSignUp) {
        ...
        if (signUpData.user) {
          ...
          if (rpcError) {
            ...
            // Profile was created, but invite acceptance failed - still navigate
          }
          ...
          toast({
            title: '¡Cuenta creada!',
            description: `Bienvenido a ${result?.workshop_name || invite.workshop_name || 'el taller'}`,
          });
